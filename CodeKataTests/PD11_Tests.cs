...
public class PD11_Tests
{
    ...
    public void ValidatePlayersHand_WhenValidHandIsGiven_NoExceptionisThrown()
    {
        ...
        var result = PD11.ValidatePlayersHand(hand);

        result.Should().BeTrue();
    }

    [TestCase("AD2D3D4D", "Not enough cards to play Poker")]
    [TestCase("AD2D3D4D5D6D", "Too many cards to play Poker")]
    [TestCase("AD2D3D4D5d", "Invalid set of cards")]
    [TestCase("AD2D3D34D", "Invalid set of cards")]
    [TestCase("0123456789", "Invalid set of cards")]
    [TestCase("abcdefghij", "Invalid set of cards")]
    public void ValidatePlayersHand_WhenInvalidHandIsGiven_ThrowsException(string hand, string message)
    {
        Action act = () => PD11.ValidatePlayersHand(hand);
    ...
    public void SplitHandsToCards_ReturnsPlayerCardsSeperately()
    {
        ...
        var result = PD11.SplitHandsToCards(hand);
    ...
    [TestCase("2C3C4C5CAD", "2C3C4C5CAD")]
    [TestCase("2C5C3CAC4C", "2C3C4C5CAC")]
    [TestCase("2CAD3CAC4C", "2C3C4CADAC")]
    [TestCase("2C7DJHACKS", "2C7DJHKSAC")]
    public void OrderCards_ReturnsCardInOrder(string hand, string expectedHand)
    {
        var result = PD11.OrderCards(hand);
    ...
    public void PlayerHand_ReturnsTwoDeckOfCards()
    {
        ...
        var result = PD11.PlayerHand(file);
    ...
    {
        var result = PD11.CardsToValueConverter(card);
    ...
    public void HighestCard_ReturnsValueOfHandWithHighestCard()
    {
        ...
        var result = PD11.HighestCard(hand);
    ...
    [TestCaseSource(nameof(ValueHandOfPairs))]
        ...
        int lastRemainderCard)
    {
        ...
        var result = PD11.CountPairValue(hand);
    ...
    [TestCase("2C3C4C5CAC", true)]
    [TestCase("2C3D4H5SAC", false)]
    [TestCase("2C3C4C5CAD", false)]
    public void HasSameSuits_ReturnsCorrectBoolean(string hand, bool expectedResult)
    {
        var result = PD11.HasSameSuits(hand);

        result.Should().Be(expectedResult);
    }

    [TestCaseSource(nameof(ValueHandOfConsecutives))]
        ...
        int highPair)
    {
        ...
        var result = PD11.ConsecutiveCards(hand);

        result.Should().HaveCount(7);
        result.Should().BeEquivalentTo(expectedResult);
    }

    [TestCaseSource(nameof(ValueHandOfDifferentHands))]
        ...
        int lastRemainderCard)
    {
        ...
        var result = PD11.HandValue(hand);
    ...
    public void AllPlayersCardsValue_ReturnsPlayersValuedHands()
    {
        ...
        var result = PD11.AllPlayersCardsValue(playerHand);
    ...
    public void WinnerOfARound_ReturnsWinnerOfTheRound()
    {
        ...
        var result = PD11.WinnerOfARound(playerOneHand, playerTwoHand).Item1;
    ...
    public void PlayerOneWins_ReturnsNumberOfPlayerOneWins()
    {
        ...
        var result = PD11.PlayerOneWins(winners);
