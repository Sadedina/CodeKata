...
namespace FunctionTest
{
    public class Tests
    {
        ...
        {
            int[] arrs = {};
            Assert.That(() => Function.Find(arrs), Throws.TypeOf<Exception>()
        ...
        {
            Assert.That(() => Function.Find(num), Throws.TypeOf<Exception>()
        ...
        {
            Assert.That(Function.Find(num), Is.EqualTo(expectedValue));
        }
