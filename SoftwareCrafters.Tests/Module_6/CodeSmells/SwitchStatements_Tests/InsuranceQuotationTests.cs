...
using License = SoftwareCrafters.Module_6.CodeSmells.SwitchStatements.License;
...
public class InsuranceQuotationTests
{
    ...
    private static InsuranceQuote BuildInsuranceQuoteForMotorist(string dateOfBirth, int points)
    {
        var age = new MotoristAge(dateOfBirth);
        var license = new License(points);

        var motorist = new Motorist(age, license);
