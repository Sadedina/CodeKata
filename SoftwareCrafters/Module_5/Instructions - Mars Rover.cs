/*
        ...
        The problem below requires some kind of input. You are free to implement any mechanism 
        for feeding input into your solution (for example, using hard coded data within a unit test). 
        ...
        that their on board cameras can get a complete view of the surrounding terrain to 
        send back to Earth.

        A rover's position is represented by a combination of an x and y co-ordinates and 
        a letter representing one of the four cardinal compass points. The plateau is 
        ...
        The possible letters are 'L', 'R' and 'M'. 'L' and 'R' makes the rover spin 90 degrees 
