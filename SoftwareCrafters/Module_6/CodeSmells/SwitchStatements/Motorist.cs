...
public class Motorist
{
    ...
    private readonly License lisence;

    public Motorist(MotoristAge motoristAge, License lisence)
    {
        this.motoristAge = motoristAge;
        this.lisence = lisence;
    }

    public int Age => motoristAge.Age;
    public int PointsOnLicense => lisence.Points;
}