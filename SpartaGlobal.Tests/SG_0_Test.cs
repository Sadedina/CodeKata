...
public class SG_0_Test
{
    [Test]
    public void WhenGivenAnEmptyArray_Function_ReturnsException()
    {
        int[] arrs = { };
        Assert.That(() => SG_0.Find(arrs), Throws.TypeOf<Exception>()
    ...
    {
        Assert.That(() => SG_0.Find(num), Throws.TypeOf<Exception>()
    ...
    {
        Assert.That(SG_0.Find(num), Is.EqualTo(expectedValue));
    }
