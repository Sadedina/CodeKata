...
public class SG_4_Test
{
    ...
    {
        Assert.That(() => SG_4.Composed(num1), Throws.TypeOf<ArgumentException>()
    ...
    {
        Assert.That(() => SG_4.Composed_2(num1), Throws.TypeOf<ArgumentException>()
            .With.Message.Contain("String is not an Integer"));
    }
    ...
    {
        Assert.That(SG_4.Composed(num1), Is.EqualTo(expectedValue));
    }
    ...
    {
        Assert.That(SG_4.Composed_2(num1), Is.EqualTo(expectedValue));
    }
}