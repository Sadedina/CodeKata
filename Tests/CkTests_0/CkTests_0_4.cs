...
namespace Tests
{
    public class CkTests_0_4
    {
        ...
        {
            Assert.That(() => CodeKata_0_4.Composed(num1), Throws.TypeOf<ArgumentException>()
        ...
        {
            Assert.That(() => CodeKata_0_4.Composed_2(num1), Throws.TypeOf<ArgumentException>()
                .With.Message.Contain("String is not an Integer"));
        }
        ...
        {
            Assert.That(CodeKata_0_4.Composed(num1), Is.EqualTo(expectedValue));
        }
        ...
        {
            Assert.That(CodeKata_0_4.Composed_2(num1), Is.EqualTo(expectedValue));
        }
    }
}