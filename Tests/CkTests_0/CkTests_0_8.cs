...
namespace Tests
{
    public class CkTests_0_8
    {
        ...
        {
            Assert.That(CodeKata_0_8.Addition(num1, num2), Is.EqualTo(expected));
        }
        ...
        {
            Assert.That(CodeKata_0_8.Subtraction(num1, num2), Is.EqualTo(expected));
        }
        ...
        {
            Assert.That(CodeKata_0_8.Multiplication(num1, num2), Is.EqualTo(expected));
        }
        ...
        {
            Assert.That(CodeKata_0_8.Division(num1, num2), Is.EqualTo(expected));
        }

        [TestCase(0.1, 0)]
        public void Division_ThrowsAnException(decimal num1, decimal num2)
        {
            Assert.That(() => CodeKata_0_8.Division(num1, num2), Throws.TypeOf<Exception>()
        ...
        {
            var result = Math.Round(CodeKata_0_8.Power(num1, num2), 2);
        ...
        {
            Assert.That(() => CodeKata_0_8.Power(num1, num2), Throws.TypeOf<Exception>()
                .With.Message.Contains("Cannot divide by Zero!"));
        }
        ...
        {
            Assert.That(Math.Round(CodeKata_0_8.Sqrt(num1), 5), Is.EqualTo(Math.Round(expected, 5)));
        }
        ...
        {
            Assert.That(() => CodeKata_0_8.Sqrt(num1), Throws.TypeOf<Exception>()
