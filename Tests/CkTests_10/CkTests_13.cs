...
namespace Tests
{
    public class CkTests_13
    {
        ...
        public void FindMatchingParenthesis_WhenValidSentenceAndInputGiven_ReturnsCorrectOutput(
            ...
            int LeftIndex)
        {
            var result = CodeKata_13.FindMatchingParenthesis(sentence, RightIndex);
        ...
        {
            Action act = () => CodeKata_13.FindMatchingParenthesis(sentence, index);
