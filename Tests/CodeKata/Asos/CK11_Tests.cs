...
namespace Tests.CodeKata.Asos
{
    public class CK11_Tests
    {
        ...
        public void ValidatePlayersHand_WhenValidHandIsGiven_NoExceptionisThrown()
        {
            ...
            var result = CodeKata11.ValidatePlayersHand(hand);
        ...
        {
            Action act = () => CodeKata11.ValidatePlayersHand(hand);
        ...
        public void SplitHandsToCards_ReturnsPlayerCardsSeperately()
        {
            ...
            var result = CodeKata11.SplitHandsToCards(hand);
        ...
        {
            var result = CodeKata11.OrderCards(hand);
        ...
        public void PlayerHand_ReturnsTwoDeckOfCards()
        {
            ...
            var result = CodeKata11.PlayerHand(file);
        ...
        {
            var result = CodeKata11.CardsToValueConverter(card);
        ...
        public void HighestCard_ReturnsValueOfHandWithHighestCard()
        {
            ...
            var result = CodeKata11.HighestCard(hand);
            ...
            int lastRemainderCard)
        {
            ...
            var result = CodeKata11.CountPairValue(hand);
        ...
        {
            var result = CodeKata11.HasSameSuits(hand);
            ...
            int highPair)
        {
            ...
            var result = CodeKata11.ConsecutiveCards(hand);
            ...
            int lastRemainderCard)
        {
            ...
            var result = CodeKata11.HandValue(hand);
        ...
        public void AllPlayersCardsValue_ReturnsPlayersValuedHands()
        {
            ...
            var result = CodeKata11.AllPlayersCardsValue(playerHand);
        ...
        public void WinnerOfARound_ReturnsWinnerOfTheRound()
        {
            ...
            var result = CodeKata11.WinnerOfARound(playerOneHand, playerTwoHand).Item1;
        ...
        public void PlayerOneWins_ReturnsNumberOfPlayerOneWins()
        {
            ...
            var result = CodeKata11.PlayerOneWins(winners);
