...
namespace Tests.CodeKata.SpartaGlobal
{
    public class CK_1_Test
    {
        ...
        public void WhenGiven50_AnswerOfRemainder_Rertuns1()
        {
            ...
            Assert.That(CodeKata_1.AnswerOfRemainder(50), Is.EqualTo(expectedResult));
        }

        [Test]
        public void WhenGiven110_AnswerOfRemainder_Rertuns2And1()
        {
            Assert.That(CodeKata_1.AnswerOfRemainder(110)["£50.00"], Is.EqualTo(2));
            Assert.That(CodeKata_1.AnswerOfRemainder(110)["£10.00"], Is.EqualTo(1));
        }
        ...
        public void WhenGiven82n88_AnswerOfRemainder_RertunsDict()
        {
            ...
            Assert.That(CodeKata_1.AnswerOfRemainder(82.88m), Is.EqualTo(expectedDict));
        }
    }
}