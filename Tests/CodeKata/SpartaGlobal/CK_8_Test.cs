...
namespace Tests.CodeKata.SpartaGlobal
{
    public class CK_8_Test
    {
        ...
        {
            Assert.That(CodeKata_8.Addition(num1, num2), Is.EqualTo(expected));
        }
        ...
        {
            Assert.That(CodeKata_8.Subtraction(num1, num2), Is.EqualTo(expected));
        }
        ...
        {
            Assert.That(CodeKata_8.Multiplication(num1, num2), Is.EqualTo(expected));
        }
        ...
        {
            Assert.That(CodeKata_8.Division(num1, num2), Is.EqualTo(expected));
        }

        [TestCase(0.1, 0)]
        public void Division_ThrowsAnException(decimal num1, decimal num2)
        {
            Assert.That(() => CodeKata_8.Division(num1, num2), Throws.TypeOf<Exception>()
        ...
        {
            var result = Math.Round(CodeKata_8.Power(num1, num2), 2);
        ...
        {
            Assert.That(() => CodeKata_8.Power(num1, num2), Throws.TypeOf<Exception>()
                .With.Message.Contains("Cannot divide by Zero!"));
        }
        ...
        {
            Assert.That(Math.Round(CodeKata_8.Sqrt(num1), 5), Is.EqualTo(Math.Round(expected, 5)));
        }
        ...
        {
            Assert.That(() => CodeKata_8.Sqrt(num1), Throws.TypeOf<Exception>()
